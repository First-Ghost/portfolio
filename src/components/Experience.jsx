export const Experience = () => {
  return (
    <div className=" lg:max-w-[1440px] lg:h-[800px] md:max-w-[704px] md:h-[461px] max-w-[375px]  h-[614px] mx-auto flex justify-center items-start   ">
      <div className="lg:w-[1110px] lg:h-[330px] border-t-2 border-b-2 border-[#242424] flex flex-col justify-end     ">
        <div
          className="lg:w-[1100px] lg:h-[255px] md:w-[704px] md:h-[451px] w-[345px] h-[604px]
  grid lg:grid-rows-2 lg:grid-cols-3 md:grid-rows-3 md:grid-cols-2 grid-cols-1 grid-rows-6 md:text-left text-center my-10"
        >
          <div className="w-[345px] md:h-[98px] h-[67px]  flex flex-col justify-between px-2  ">
